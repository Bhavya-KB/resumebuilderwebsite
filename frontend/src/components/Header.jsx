      ...
      <AppBar position="static" >
        <Toolbar>
          <IconButton
            ...
            sx={{ mr: 2 }}
          >
           <img src="https://image.winudf.com/v2/image1/Y29tLmZ1dHVyZXRlY2gucmVzdW1lbWFrZXJfaWNvbl8xNTUzMjQwMzQxXzA1Nw/icon.png?w=&fakeurl=1" alt="" style={{width:"50px"}} />
          </IconButton>
          <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
           <Link to={"/"} style={{textDecoration:"none",color:"white",fontSize:"30px"}}> Resume Builder</Link>
          </Typography>
